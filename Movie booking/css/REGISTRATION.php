...
<p style="color: yellow;">&nbsp; Movie Ticket Reservation</p>
...
your movie world experience through technology"</p>
<div id='cssmenu'><ul>
 <li class='active'">
...
<div class="left">
<a href="https://www.facebook.com/" target="_blank"><img alt="" style="border: 2px solid ; width: 201px; height: 146px; float: left;" src="pics/link/facebook.jpg"></a>
<a href="https://twitter.com/login" target="_blank"><img alt="" style="border: 2px solid ; width: 201px; height: 178px; float: left;" src="pics/link/twitter.jpg"></a>
<a href="https://instagram.com/accounts/login/"target="_blank"><img alt="" style="border: 2px solid ; width: 201px; height: 170px; float: left;" src="pics/link/insta.jpg"></a>
<a href="https://accounts.google.com/ServiceLogin?elo=1" target="_blank"><img src="pics/link/gmail.jpg" alt="" height="190" style="border: 2px solid; width: 201px; height: 195px; float: left;"></a>
</div>
<div class="mid">
...
echo'<script type="text/javascript">alert("Enter atleast 4-20 Character!")</script>';
}
}
else{
echo'<script type="text/javascript">alert("Enter atleast 4-20 Character!")</script>';
...
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 20px; color: black; font-weight:bolder">E-mail Addrress:</p>
...
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 20px; color: black; font-weight:bolder">Re-type Password</p>
...
&nbsp;&nbsp;&nbsp;<span style="color: white;"><big>Online Movie Ticket Reservation</big></span><br>
